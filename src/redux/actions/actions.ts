...
export const fetchData = (): ThunkAction<void, RootState, unknown, Action<string>> => async (dispatch: Dispatch): Promise<void> => {
...
export const fetchCountryCases = (category: string): ThunkAction<void, RootState, unknown, Action<string>> => async(dispatch: Dispatch): Promise<void> => {
